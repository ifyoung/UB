...
- (void)setTextColor:(UIColor *)textColor afterOccurenceOfString:(NSString*)separator count:(NSInteger)count{
    
    separator  = [separator substringWithRange:NSMakeRange(separator.length - 1, 1)];
    NSRange range = [self.text rangeOfString:separator];
...
- (void)setFont:(UIFont *)font afterOccurenceOfString:(NSString*)separator count:(NSInteger)count{
