...
- (void)drawRect:(CGRect)rect{
    ...
    CGContextMoveToPoint(context,    self.width / 2.0 - 70, (self.height - 20) / 2.0);
    CGContextAddLineToPoint(context, self.width / 2.0 - 70,(self.height - 20) / 2.0  + 20);
    CGContextStrokePath(context);
    
    CGContextMoveToPoint(context,    self.width / 2.0 - 80, self.height /2.0);
    CGContextAddLineToPoint(context, self.width / 2.0 - 60 , self.height /2.0 );
    CGContextStrokePath(context);
